...
@router.get('/users/', response_model=List[RetrievedUser])
async def get_users(
...
@router.get('/user/{target}', response_model=RetrievedUser)
async def get_user(
...
@router.post('/users/', response_model=RetrievedUser)
...
@router.put('/user/{target}', response_model=RetrievedUser)
